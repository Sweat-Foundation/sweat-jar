...
fn run_shard_splits_worklist() {
    ...
    assert_eq!(s0.processed + s1.processed, 6);
    ...
    assert_eq!(ids.len(), 6, "each account reconciled exactly once across shards");
}
